    ...
    <div className="group relative rounded-xl shadow-lg overflow-hidden transform transition-all cursor-pointer">
      ...
      >
        <div className="flex flex-col">
          <div className="flex justify-between bg-white shadow p-2 sticky rounded-t-lg">
          ...
          <div className="md:flex md:flex-row overflow-auto ">
            <div className="md:w-1/2">
              <Carousel className="border-1 m-1 shadow-lg md:h-full">
