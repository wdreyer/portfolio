...
const Projects = () => {
    const projects = [
        {
            title: 'AeshManager',
            mainImage: AeshManagerMain,
            techIcons: [FaJsSquare, FaReact, FaFire],
            shortDescription: 'Simplifiez la création des plannings pour les AESH et les enfants.',
            ...
            carouselImages: [Aesh1, Aesh2, Aesh3, Aesh4]
        },
        // Ajoutez plus de projets ici
    ];

    return (
        <section className="h-[38rem] pt-14 flex flex-col items-center bg-slate-100 bg-opacity-10 shadow">
